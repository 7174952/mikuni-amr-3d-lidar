...
def timeProcess(event):
    ...
    if gDoesWorkTimer:
       msg.slave_id = 15       # スレーブID指定(ID Shareモードのときはglobal_idとみなされる)
...
def main():
    ...
    rospy.set_param("/om_modbusRTU_1/global_id", "15")
    ...
    msg.data[2] = 12000       # DDO運転速度(初期単位：r/min)
    ...
    msg.data[9] = 12000       # DDO運転速度(初期単位：r/min)
    msg.data[10] = 1000      # DDO加速レート(初期単位：ms)
    msg.data[11] = 1000     # DDO減速レート(初期単位：ms)
    msg.data[12] = 1000
    ...
    msg.func_code = 1       # 0:read 1:write 2:read/write
    msg.write_addr = 0x0000 # 書き込むアドレスの起点
    msg.write_num =14       # 書き込むデータ数*軸数=12
    # 1軸目のデータ
    msg.data[0] = 16        # DDO運転方式 16:連続運転(速度制御)
    msg.data[1] = 0         # DDO運転位置(初期単位：1step = 0.01deg)連続運転(速度制御)なので無関係
    msg.data[2] = 24000       # DDO運転速度(初期単位：r/min)
    msg.data[3] = 1000      # DDO加速レート(初期単位：ms)
    msg.data[4] = 1000      # DDO減速レート(初期単位：ms)
    msg.data[5] = 1000
    msg.data[6] = 1         # DDO運転トリガ設定
    ...
    msg.data[7] = 16        # DDO運転方式 16:連続運転(速度制御)
    msg.data[8] = 0         # DDO運転位置(初期単位：1step = 0.01deg)連続運転(速度制御)なので無関係
    msg.data[9] = 24000       # DDO運転速度(初期単位：r/min)
    msg.data[10] = 1000      # DDO加速レート(初期単位：ms)
    msg.data[11] = 1000     # DDO減速レート(初期単位：ms)
    msg.data[12] = 1000
    msg.data[13] = 1        # DDO運転トリガ設定
    ...
    msg.data[0] = 16        # DDO運転方式 16:連続運転(速度制御)
    msg.data[1] = 0         # DDO運転位置(初期単位：1step = 0.01deg)連続運転(速度制御)なので無関係
    msg.data[2] = 36000       # DDO運転速度(初期単位：r/min)
    msg.data[3] = 1000      # DDO加速レート(初期単位：ms)
    msg.data[4] = 1000      # DDO減速レート(初期単位：ms)
    msg.data[5] = 1000
    msg.data[6] = 1         # DDO運転トリガ設定
    ...
    msg.data[7] = 16        # DDO運転方式 16:連続運転(速度制御)
    msg.data[8] = 0         # DDO運転位置(初期単位：1step = 0.01deg)連続運転(速度制御)なので無関係
    msg.data[9] = 36000       # DDO運転速度(初期単位：r/min)
    msg.data[10] = 1000      # DDO加速レート(初期単位：ms)
    msg.data[11] = 1000     # DDO減速レート(初期単位：ms)
    msg.data[12] = 1000
    ...
    msg.data[7] = 16        # DDO運転方式 16:連続運転(速度制御)
    msg.data[8] = 0         # DDO運転位置(初期単位：1step = 0.01deg)連続運転(速度制御)なので無関係
    msg.data[9] = 0         # DDO運転速度(初期単位：r/min)
    msg.data[10] = 1000      # DDO加速レート(初期単位：ms)
    msg.data[11] = 3000     # DDO減速レート(初期単位：ms)
    msg.data[12] = 1000
    msg.data[13] = 1        # DDO運転トリガ設定
    # 配信
    gDoesWorkTimer = False
