...
#include "om_modbus_master/IServerParamCommunicator.h"
...
public:
  Base();
  ~Base();
  void init(RosMessage *ros_mes_obj, ICheckData *check_obj[], IConvertQueryAndResponse *convert_obj[], ICheckIdShareMode *check_idshare_obj, IServerParamCommunicator *server_param_communicator);
