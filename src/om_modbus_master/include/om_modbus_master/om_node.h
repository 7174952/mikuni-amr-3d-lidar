...
void init(std::vector<int>& first, std::vector<int>& second, Base *base_obj, ICheckData *check_obj[], IConvertQueryAndResponse *convert_obj[], ICheckIdShareMode *check_idshare_obj, RosMessage *rosmes_obj, IServerParamCommunicator *server_communicator_obj);
